<template>
    <header class="fixed z-50 w-screen antialiased bg-white shadow dark:bg-gray-800">
    ...
    <nav class="border-gray-200 px-4 lg:px-6 py-2.5">
        <div class="flex flex-wrap items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a class="flex mr-4">
                    <img src="https://seeklogo.com/images/B/bank-bpd-bali-logo-687C6FCAC4-seeklogo.com.png" alt="Bank Bpd Bali Logo PNG Vector" title="Bank Bpd Bali Logo PNG Vector" class="h-8 mr-3">
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">BPD SURAT</span>
                </a>
            ...
            <div class="flex items-center lg:order-2">
                ...
                <div class="z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown">
                    ...
                    <a href="#" class="block py-2 text-base font-medium text-center text-gray-900 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700 dark:text-white dark:hover:underline">
                        ...
                        <svg aria-hidden="true" class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 12a2 2 0 100-4 2 2 0 000 4z"></path><path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"></path></svg>
                        View all
                        </div>
                    </a>
                </div>
