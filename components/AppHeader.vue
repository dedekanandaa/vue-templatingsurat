<template>
    <header class="antialiased fixed w-screen bg-white dark:bg-gray-800 z-50 shadow">
    ...
    <nav class="border-gray-200 px-4 lg:px-6 py-2.5">
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a class="flex mr-4">
                    <img src="https://seeklogo.com/images/B/bank-bpd-bali-logo-687C6FCAC4-seeklogo.com.png" alt="Bank Bpd Bali Logo PNG Vector" title="Bank Bpd Bali Logo PNG Vector" class="mr-3 h-8">
